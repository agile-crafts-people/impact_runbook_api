...
CONTAINER_IMAGE ?= ghcr.io/agile-crafts-people/impact_runbook_api:latest
...
delete-package:
	...
	@gh api -X DELETE "/orgs/agile-crafts-people/packages/container/impact_runbook_api"
...
open:
	@echo "Opening web UI..."
	@open -a 'Google Chrome' 'http://localhost:9091' || google-chrome 'http://localhost:9091' || xdg-open 'http://localhost:9091'
